...
// $toolsList = $tool_Down_Controller->getAllTollDown();
...
<div class="container bg-white mb-4">
    ...
    <div class="row">
        ...
        <aside class="col-lg-4 siderbar bg-white p-0 side_area">
            <ul>
                <li class="box_header justify-content-center d-flex border text-dark">𝓣𝓸𝓸𝓵𝓼 𝓒𝓪𝓽𝓮𝓰𝓸𝓻𝓲𝓮𝓼</li>
                <?php
            ...
            ?>
                    ...
                    <a href="tool_download.php?id=<?php echo $item['id']; ?>">
                        <div class="card-body row g-0 tool_area">
                            <div class="col-lg-5 d-flex flex-column align-items-center justify-content-center p-2">
                                <img id="myVideo2" src="uploads/<?php echo $item['image']; ?>" class="shadow rounded-0" width="300px" height="150px" controls></img>
                ...
                ?>
                    <a href="tool_download.php?id=<?php echo $lasted['id']; ?>">
                        <div class="card-body row g-0 tool_area">
                            <div class="col-lg-5 d-flex flex-column align-items-center justify-content-center p-2">
                                <img id="myVideo2" src="uploads/<?php echo $lasted['image']; ?>" class="shadow rounded-0" width="300px" height="150px" controls></img>
