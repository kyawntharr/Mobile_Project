                ...
                <div class="rounded-1 border border-1 team">
                    <div class="team_img1 bg-white">
                        <div class="p-3 d-flex align-items-center justify-content-around flex-column team_img2">
                            <img src="uploads/team/<?php echo $team['image']; ?>" alt="" class="img-fluid rounded-circle"
                    ...
                    <div class="d-flex flex-column team_detail">
                        ...
                        <div class="py-3 align-items-center d-flex justify-content-center team_btn">
                            <a href="index.php?id='.<?php $team['id']; ?>.'" class="btn btn-primary btn-sm"
                                data-bs-toggle="modal" data-bs-target="#t_member<?php echo $team['id']; ?>">Details</a>
                        </div>

                        <div class="modal fade" id="t_member<?php echo $team['id']; ?>" data-bs-backdrop="static"
                                ...
                                <div class="modal-content">
                                    <div class="modal-header d-flex justify-content-center align-items-center">
                                        <div class="team_img col-md-4 text-center">
                                            <img src="uploads/team/<?php echo $team['image']; ?>" alt=""
